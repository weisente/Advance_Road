...
public class WrapRecyclerView extends RecyclerView {
    ...
    public void setAdapter(Adapter adapter) {
        // 为了防止多次设置Adapter  如果当已经存在Adapter  则把之前的Adapter释放了  然后 再设置
        if(mAdapter != null){
...
//            super.onItemRangeRemoved(positionStart, itemCount);
    ...
    //自定义的长点击事件
    public example.weisente.top.baselibrary.recycleviewbase.adapter.OnLongClickListener mLongClickListener;

    public void setOnItemClickListener(OnItemClickListener itemClickListener) {
        this.mItemClickListener = itemClickListener;
    }

    public void setOnLongClickListener(example.weisente.top.baselibrary.recycleviewbase.adapter.OnLongClickListener longClickListener) {
