...
public class AlertDialog extends Dialog {
    ...
    private HolderImageLoader imageLoader;
    ...
    public void setImageView(int imageViewId,String Path){
        View imageView = mAlert.getView(imageViewId);
        if( imageView instanceof ImageView){
            imageLoader.displayImage(imageView.getContext(), (ImageView) imageView,Path);
        }else{
            new Throwable("该ID并不是一个Imageview的id");
        }
    }
